...
*/
#ifndef NECTA_CAMERA_H
#define NECTA_CAMERA_H
...
class NectaCaptureThread : public QThread
{
    Q_OBJECT
public:
    NectaCaptureThread(int camera, QMutex *lock);
    NectaCaptureThread(QString videoPath, QMutex *lock);
    ~NectaCaptureThread();
